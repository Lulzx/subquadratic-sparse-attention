...
| 5 | Conversion of a dense pretrained donor without losing language quality | Not reproduced | No pretrained language-model surgery or recovery training has been performed. |
