...
6. **Variable-length retrieval**: improve the current seed-0 result from 2/9 without regressing 9/9 exact or 8/8 dense-pass lexical-mismatch cases, then repeat all router results across seeds.
